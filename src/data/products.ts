...
// Gender tagging for the Men / Women navigation. Women's-specific pieces are tagged
// "women"; everything else is unisex and shows under both Men and Women.
for (const p of staticCollections["the-collection"].products) {
  p.gender = /women/i.test(p.title) ? "women" : "unisex";
}
